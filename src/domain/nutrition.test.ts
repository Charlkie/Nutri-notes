...
describe("nutrition calculations", () => {
  ...
  it("calculates liquid nutrition from a per-mL basis",()=>{const result=calculateNutrients(food({calculationMode:"per100",baseQuantity:1,baseUnit:"ml",calories:.6,protein:.03,carbohydrates:.05,fat:.035}),250);expect(result).toMatchObject({calories:150,protein:7.5,carbohydrates:12.5,fat:8.75})});
