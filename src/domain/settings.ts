...
export const defaultSettings:AppSettings={appearance:"dark",accentColour:"#b7f36b",weekStartsOn:1,copyConsumedState:"reset",weightUnit:"kg",targets:{calories:2200,protein:160,carbohydrates:240,fat:70}};
